...
const FORMATS = [
  { id: "script", format: "Текстовый сценарий ведущего", badge: "СЦЕНАРИЙ", accent: "plasma" },
  { id: "visual", format: "Визуальные идеи и концепция", badge: "ВИЗУАЛ", accent: "electric" },
  { id: "plan", format: "Сценарный план", badge: "ПЛАН", accent: "plasma" },
  { id: "jokes", format: "Банк шуток и подводок", badge: "ЮМОР", accent: "electric" },
  { id: "checklist", format: "Чек-лист подготовки", badge: "ЧЕК-ЛИСТ", accent: "plasma" },
  { id: "ideas", format: "Список идей и активностей", badge: "ИДЕИ", accent: "electric" },
];
